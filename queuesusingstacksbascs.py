...
class Queue:
    ...
    def enqueue(self,value):
        ...
        if self.rear is None:
            # same as self.front, as you only have one element
            ...
            # then do not forget to increase the size by one every time you enqueue
        self.size +=1

    def dequeue(self):# we remove the front element if the queue is not empty
